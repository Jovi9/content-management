...
@section('content')
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>CoEd Spearheads BUROGKOS: a team building activity, enchances gender sensitive powerhouse</h1>
                        <p>The Languages Department of the College of Humanities and Social Sciences (CHUMMS) organized
                            "Lektura Palihan sa Sining Pantanghalan", a workshop aiming to educate and train students about
                            the basic concepts of stage art.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5" id="banner" style="background-image: url({{ asset('storage/logo/site_banner.png') }})">
        <div class="container-fluid mb-5 mt-5">
            <h2 class="pb-2 border-bottom border-4 mb-5 mt-5 container text-white"><strong>News and Updates</strong></h2>
    ...
    <section class="featured">
        <div class="container py-5">
            <div class="container mt-5 mb-5">
                <h2 class="pb-2 border-bottom border-4 text-white mt-5 mb-5"><strong>Featured</strong></h2>
            </div>
                    ...
                    <div class="col">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><strong>Card title</strong></h5>
                                <p class="card-text cut-text">Words in the woods are found anywhere in the world. Words
                                    in the woods are found around the world.Words in the woods are found anywhere in the
                                    world. Words
                                    in the woods are found around the world.Words in the woods are found anywhere in the
                                    world. Words
                                    in the woods are found around the world.Words in the woods are found anywhere in the
    ...
    <section class="py-5" id="banner" style="background-image: url({{ asset('storage/logo/site_banner.png') }})">
        <div class="container mt-5 mb-5">
            <h2 class="pb-2 border-bottom border-4 text-white mt-5 mb-5"><strong>Gallery</strong></h2>
        </div>
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mb-5">
    ...
    <section class="featured">
        <div class="container py-5">
            <div class="container mt-5 mb-5">
                <h2 class="pb-2 border-bottom border-4 text-white mt-5 mb-5"><strong>Partners</strong></h2>
            </div>
