<div>
    <div class=" flex justify-between">
        ...
        {{-- <div x-data="" x-on:click.prevent="$dispatch('open-modal', 'add-content')"
    ...
    {{-- add modal --}}
    <x-modal-v1 name="add-content" focusable maxWidth="md">
        <form action="javascript:void(0);" wire:submit.prevent="store" novalidate>
            ...
            <div class="bg-white p-5">
                ...
                <div class="mt-4">
                    ...
                    <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                        ...
                        <input type="file" wire:model="attachment" wire:click="resetAttachment()"
                            id="upload{{ $randomID }}"
                            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                            required>
                        @error('attachment')
            ...
            <div class="bg-gray-300 p-4">
                <div class="flex justify-end space-x-2">
                    <button type="button" x-on:click="$dispatch('close-modal', 'add-content')" wire:click="resetForm()"
