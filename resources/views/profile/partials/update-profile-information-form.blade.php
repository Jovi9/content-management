<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="employeeID" name="employeeID" type="text" class="mt-1 block w-full" :value="old('employeeID', $user->employeeID)"
                required autofocus autocomplete="employeeID" />
        ...
        <div>
            ...
            <x-text-input id="middleInitial" name="middleInitial" type="text" class="mt-1 block w-full"
                :value="old('middleInitial', $user->middleInitial)" autofocus autocomplete="middleInitial" />
        ...
        <div>
            ...
            <x-text-input id="user_type" name="user_type" type="text" class="mt-1 block w-full"
                value="{{ $userType }}" required autofocus autocomplete="user_type" required readonly />
