...
@section('page-header', 'Edit Content of ' . $menuName)
@section('content')
                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="col-md-12">
                                ...
                                @if ($requestFrom === '')
                                    @if ($subURI === 'none')
                                        <a href="{{ route('admin.contents-show', ['main' => $mainURI]) }}"
                                            class="btn btn-secondary">Cancel</a>
                                    @else
                                        <a href="{{ route('admin.contents-show', ['main' => $mainURI . '/' . $subURI]) }}"
                                            class="btn btn-secondary">Cancel</a>
                                    @endif
                                @else
                                    <a href="{{ route('admin.contents-manage') }}" class="btn btn-secondary">Cancel</a>
                                @endif
                            </div>
                        </form>
                    </div>
